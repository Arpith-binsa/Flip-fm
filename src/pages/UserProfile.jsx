    ...
    <div className="min-h-screen bg-black text-white p-8">
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="relative max-w-[600px] mx-auto">
          ...
          <div ref={profilePicRef} className="absolute top-0 left-0 w-20 h-20 md:w-24 md:h-24 rounded-full border-4 border-black bg-gradient-to-br from-blue-500 to-purple-500 overflow-hidden shadow-2xl transform -translate-y-1/4 translate-x-[-0.5rem] pointer-events-none">
            {profile?.avatar_url ? (
